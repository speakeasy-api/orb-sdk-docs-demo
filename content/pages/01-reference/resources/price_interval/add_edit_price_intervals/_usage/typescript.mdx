...
const addEditPriceIntervalParams: AddEditPriceIntervalParams = {
  add: [
    {
      discounts: [
        "string",
  ...
  const res = await sdk.priceInterval.addEditPriceIntervals(subscriptionId, addEditPriceIntervalParams);
